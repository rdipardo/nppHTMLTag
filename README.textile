...
* GitHub emoji decoding (example: @:clown_face:@ to 🤡)
* autocompletion of HTML entities and GitHub emoji
...
| Ctrl+Shift+E | to _decode_ all selected HTML entities or GitHub emoji |
