...
* Open the "HTMLTag-translations.ini":dat/HTMLTag-translations.ini file and create a section like the following:
...
** save your edited @HTMLTag-translations.ini@ file in the same folder as the old @localizations.ini@ file
...
[5]https://github.com/rdipardo/nppHTMLTag/edit/default/CONTRIBUTING.textile#user-content-l10n-preview
