...
#define HTMLTAG_VERSION L"1.5.6.1\0"
#define HTMLTAG_VERSION_WORDS 1, 5, 6, 1

#define ID_ABOUT_HTML_TAG_DLG 0x1000
#define ID_UNICODE_FMT_CONFIG_DLG 0x2000

#define ID_ABOUT_HTML_TAG_DLG_CJK 0x0200
#define ID_UNICODE_FMT_CONFIG_DLG_CJK 0x0201
#define ID_ABOUT_HTML_TAG_DLG_RTL 0x0300
#define ID_UNICODE_FMT_CONFIG_DLG_RTL 0x0301

#define DEFAULT_CAPTION L"HTML Tag plugin for Notepad++"
#define ID_PLUGIN_VERSION_TXT (ID_ABOUT_HTML_TAG_DLG + 0x1)
#define DEFAULT_VERSION_TXT L"Version"
...
#define PLUGIN_MAINTAINER_COPYRIGHT L"\251 2022-2025 Robert Di Pardo (v1.2 -)"

#define ID_PLUGIN_LICENSE_TXT (ID_ABOUT_HTML_TAG_DLG + 0x40)
#define PLUGIN_LICENSE L"Licensed under the MPL 2.0"

#define DEFAULT_ABOUT_3RD_PARTY L"Using"
...
#define DEFAULT_ABOUT_3RD_PARTY_ALSO L"Also using"
...
#define DEFAULT_ENTITIES_FILE_TXT L"HTML entities file"
#define DEFAULT_L10N_FILE_TXT L"Localizations file"
...
#define DEFAULT_UNICODE_FORMAT_LABEL L"Unicode character format:"
#define DEFAULT_UNICODE_CONFIG_LABEL L"Configure"

#define DEFAULT_UNICODE_EDIT_CAPTION L"Change Unicode character prefix"
...
#define DEFAULT_UNICODE_EDIT_LABEL L"Format:"
#define DEFAULT_UNICODE_BTN_OK_TXT L"&OK"
#define DEFAULT_UNICODE_BTN_CANCEL_TXT L"&Cancel"
#define DEFAULT_UNICODE_BTN_RESET_TXT L"&Reset"
