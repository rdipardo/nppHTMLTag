...
* 1.5.5 (2025-10-28)
** Fixed: ignore stray @﹤@'s when searching for start tags (#6, "#15":15) [3db20ae]
** Changed: translating the About dialog no longer requires a resource file [ca3e62c]
** Added: translations for Serbian (Latin and Cyrillic) ("#14":14)

* 1.5.4 (2025-06-18)
** Fixed: HTML entities will be decoded even if the current selection contains a colon (@:@) [fd48ac0], regressed in [139908f]

bq. *Note*
This release includes all the same features and bug fixes as "v1.5.3":https://bitbucket.org/rdipardo/htmltag/src/d74b7de/NEWS.textile
...
** Changed: dialog translation strings are now saved in a @dialogs.ini@ file[^1^] located in @{%AppData%\Notepad++,$(PORTABLE_NPP_DIR)}\plugins\Config\HTMLTag@ [0a4c16e]
...
* 1.5.3 (2025-06-16)
** Fixed: text containing 4-digit Unicode escapes will decode as expected, regressed in v1.5.0/2 ("#13":13) [6a27eb9]
** Fixed: alphanumeric entities like @＆sup1;@ will decode as expected, also regressed in v1.5.0/2 [0c67848]
** Added: "GitHub emoji":https://gist.github.com/rxaviers/7360908 can be decoded by the 'Decode entities' command[^1^] and inserted when entity autocompletion is enabled [139908f]
