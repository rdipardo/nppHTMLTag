...
bq. [^1.^] Edits to @dialogs.ini@ are applied immediately. However, changing the window position of translation text is not possible without editing the language's "RC script":rcs and "rebuilding":rebuilding the plugin. The main purpose of editable dialog text is to help future translators preview their work.
